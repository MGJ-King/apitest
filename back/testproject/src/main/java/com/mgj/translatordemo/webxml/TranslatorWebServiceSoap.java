...
public interface TranslatorWebServiceSoap {
     ...
     * @param word
     * @return
     *     returns com.mgj.translatordemo.webxml.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getEnCnTwoWayTranslator", targetNamespace = "http://WebXml.com.cn/", className = "com.mgj.translatordemo.webxml.GetEnCnTwoWayTranslator")
    @ResponseWrapper(localName = "getEnCnTwoWayTranslatorResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.mgj.translatordemo.webxml.GetEnCnTwoWayTranslatorResponse")
    ...
    @RequestWrapper(localName = "HelloWebXml", targetNamespace = "http://WebXml.com.cn/", className = "com.mgj.translatordemo.webxml.HelloWebXml")
    @ResponseWrapper(localName = "HelloWebXmlResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.mgj.translatordemo.webxml.HelloWebXmlResponse")
